      ...
      (SEMICOLON.header = {
        ...
        initialize: function () {
          (a = c.outerHeight()),
            ...
            e(
              ".top-links-item:has(.top-links-sub-menu,.top-links-section) > a:not(:has(.icon-chevron-down)), .menu-item:not(.mega-menu-title):has(.sub-menu-container) > .menu-link > div:not(:has(.icon-chevron-down)), .page-menu-item:has(.page-menu-sub-menu) > a > div:not(:has(.icon-chevron-down))"
            ),
            e(
