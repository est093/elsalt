!(function (e) {
  ...
  function (e, n, t) {
    ...
    !(function () {
      ...
      function n() {
        ...
        return (
          n >= 55 && !!t && "cellular" === t.type && t.downlinkMax <= 0.115
        );
      }
      function t(e) {
      ...
      !(function () {
        ...
        function p() {
          ...
          return (
            T &&
              (T.version && (r.versions.fl = T.version),
              T.icTag && (r.icTag = T.icTag),
              (r.siteToken = T.token)),
            A &&
        ...
        function v(r) {
          ...
          if (
            ...
            var w =
                null !== (o = g.getEntriesByType("resource")) && void 0 !== o
                  ? o
                  : [],
              E = 0,
              S = 0;
            w.forEach(function (e) {
              ...
              v.tempResources &&
                void 0 === v.tempResources[S] &&
                (v.tempResources[S] = []);
              var r = JSON.stringify(n).length;
              E + r < 62e3 && v.tempResources
                ? ((E += r), v.tempResources[S].push(n))
                : (S++, (E = 0));
            });
          }
          return (
            ...
            void 0 !== P &&
              ...
              delete v.memory,
              delete v.errorCount,
              delete v.documentWriteIntervention),
            v
          );
        }
        function m(e) {
          var n;
          if ("first-contentful-paint" === e && A.fcp && A.fcp.value)
            return A.fcp.value;
          if ("function" == typeof g.getEntriesByType) {
            var t =
          ...
          if (g && T && T.token) {
            ...
            document.addEventListener("visibilitychange", function () {
              if ("hidden" === document.visibilityState) {
                if (x && q()) {
                  var n = e();
                  ((null === B || void 0 === B ? void 0 : B.url) == n &&
                    null !== B &&
                    void 0 !== B &&
                    B.triggered) ||
                    M(),
            ...
            var A = {},
                  ...
                  var t = n.sources.reduce(function (e, n) {
                    return e.node &&
                      e.previousRect.width * e.previousRect.height >
                        n.previousRect.width * n.previousRect.height
                      ? e
                      : n;
                  });
                  if (t) return t;
              ...
              k = function (e) {
                var n = window.location.pathname,
                  t = F(e.entries);
                switch (
                  ((A[e.name.toLowerCase()] = { value: e.value, path: n }),
                  e.name)
                ) {
                  case "CLS":
                    (t = I(e.entries)) &&
                  ...
                  case "FID":
                    t &&
                      A.fid &&
                      ((A.fid.element = N(t.target)), (A.fid.name = t.name));
                    break;
                  case "LCP":
                    t &&
                      A.lcp &&
                      ((A.lcp.element = N(t.element)),
                      (A.lcp.size = t.size),
                      (A.lcp.url = t.url));
                }
              };
            ...
            var q = function () {
              ...
              H = function (e) {
                w.push({ id: h, url: e, ts: new Date().getTime() }),
                  w.length > 3 && w.shift();
              };
            x &&
              ((R = e()),
              (function (n) {
                ...
                if (t) {
                  var r = function () {
                    (h = c()),
                      "function" == typeof g.clearResourceTimings &&
  ...
  function (e, n, t) {
    ...
    (n.__esModule = !0),
      (n.sendObjectBeacon = void 0),
      (n.sendObjectBeacon = r);
  },
  function (e, n, t) {
    "use strict";
    (n.__esModule = !0),
    ...
    var r,
            ...
            e.forEach(function (e) {
              "first-contentful-paint" === e.name &&
                ...
                e.startTime < i.firstHiddenTime &&
                  ((o.value = e.startTime - d()), o.entries.push(e), t(!0)));
            });
          },
          c =
            window.performance &&
          ...
          "pointerdown" == e.type
            ? (function (e, n) {
                var t = function () {
                  ...
                  i = function () {
                    removeEventListener("pointerup", t, C),
                      removeEventListener("pointercancel", r, C);
                  };
                addEventListener("pointerup", t, C),
      ...
      H = function (e, n) {
        ...
        (r = m(e, i, t, n.reportAllChanges)),
          a &&
            ...
            v(function () {
              o(a.takeRecords()),
                i.value < 0 && M() > 0 && ((i.value = 0), (i.entries = [])),
                r(!0);
            }),
            s(function () {
              (V = []),
      ...
      z = function (e, n) {
        ...
        if (c) {
          ...
          var u = function () {
            J[o.id] ||
              (a(c.takeRecords()), c.disconnect(), (J[o.id] = !0), t(!0));
          };
